...
export default function Products() {
    ...
    const ShowProducts = () => {
        return (
            <>
                <div className="buttons d-flex mb-5 pb-5 items ">
                    ...
                    return (
                        <>
                            <div className="col-md-3 mb-4 py-4" id="p">
                                ...
                                <Link to={`/fav/${product.id}`} className='btns2' type='button' onClick={()=>addfav(product)}>
    ...
    return (
        <div className='home'>
            <div>
                <div className="row">
                    <div>
                        <h1 className='header'>Letest Products...</h1>
                        <hr/><br/>
                    </div>
                </div>
                <div className="row">
